function BugReportHero({ submitted }) {
  return (
    <div className="relative flex flex-col items-center text-center px-6 pt-36 pb-24 overflow-hidden">
      ...
      >
        <span className="text-4xl sm:text-5xl md:text-6xl lg:text-[64px] xl:text-[72px]">
          Good{" "}
        ...
        <br />
        <span className="text-4xl sm:text-5xl md:text-6xl lg:text-[66px] xl:text-[76px]">
